...
public class DelAddm extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == b1) {
            ...
            try {
                ...
                if (a.equals(b)) {
                    l3 = new JLabel("This DATA will get DELETED Permanently");
                    p2.remove(l2);
                    p2.remove(t1);
                    p2.remove(b1);
                    p2.remove(b2);
                    ...
                    try {
                        ...
                        rs3 = st4.executeQuery("select * from stdeadlock where prn='"+a+"';");
        ...
        } else if (e.getSource()==b4)
        {
            try {
                ...
                inp = "delete from stdeadlock where prn='" + asd + "';";
